package com.coder.employeesmanagment.JWTsecurity.security.jwt;
...
import com.coder.employeesmanagment.JWTsecurity.security.services.*;
	 ...
	 private static final Logger logger = LoggerFactory.getLogger(JwtProvider.class);
	    ...
	    public String generateJwtToken(Authentication authentication) {
	          ...
	          return Jwts.builder() 
	    		            ...
	    		            .setExpiration(new Date(System.currentTimeMillis() + jwtExpiration * 1))
